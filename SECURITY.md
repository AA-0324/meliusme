MeliusMe is built with a "Secure-by-Design" philosophy. By eliminating cloud dependencies and storing all data locally on the user's device, the attack surface is significantly reduced. However, it is important to keep in mind that no software is 100% immune to vulnerabilities.

At this stage of development, security audits are focused on the following versions:

| Version | Supported |        
| v0.6-alpha (Current) | Yes |
...
2. Private Disclosure: Please report any findings directly to me via email at arvindakshar@sewanhakaschools.org.
...
* Logic Audits: Manually reviewing AI-generated code for "hallucinated" security flaws.
