...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      {/* Weekly Stats */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="px-6 grid grid-cols-3 gap-3 mb-6">
      ...
      {isPro && (settings.goals.protein || settings.goals.fiber || settings.goals.sugar) && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="px-6 mb-6">
            ...
            <div className="flex items-center justify-around">
              {settings.goals.protein && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-bold">{todayTotals.protein}g</p>
              ...
              {settings.goals.fiber && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-bold">{todayTotals.fiber}g</p>
              ...
              {settings.goals.sugar && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-bold">{todayTotals.sugar}g</p>
      ...
      {/* Weekly Bar Chart */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="px-6 mb-6">
        <div className="bg-card rounded-3xl p-6 border border-border">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="px-6 mb-6">
        <div className="bg-card rounded-3xl p-6 border border-border relative overflow-hidden">
          ...
          {isPro ? (
            mealsByType.length > 0 ? (
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <div className="w-32 h-32 flex-shrink-0">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={mealsByType} cx="50%" cy="50%" innerRadius={30} outerRadius={55} paddingAngle={0} strokeWidth={0} dataKey="value">
            ...
            <button onClick={() => setShowProModal(true)} className="w-full h-32 flex flex-col items-center justify-center gap-3 bg-secondary/50 rounded-2xl hover:bg-secondary transition-colors">
      ...
      {isPro && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="px-6 mb-6">
          <div className="bg-card rounded-3xl p-6 border border-border">
            <div className="flex items-center gap-2 mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-secondary/50 rounded-xl p-4">
                ...
                <div className="text-2xl font-bold">
                  {Math.round(weekData.flatMap((d) => d.meals).reduce((sum, m) => sum + (m.protein || 0), 0) / Math.max(weeklyStats.daysWithMeals, 1))}g
                </div>
              ...
              <div className="bg-secondary/50 rounded-xl p-4">
                ...
                <div className="text-2xl font-bold">
                  {Math.round(weekData.flatMap((d) => d.meals).reduce((sum, m) => sum + (m.fiber || 0), 0) / Math.max(weeklyStats.daysWithMeals, 1))}g
                </div>
                <div className="text-xs text-muted-foreground">per day</div>
              </div>
              <div className="bg-secondary/50 rounded-xl p-4">
                ...
                <div className="text-2xl font-bold">
                  {Math.round(weekData.flatMap((d) => d.meals).reduce((sum, m) => sum + (m.sugar || 0), 0) / Math.max(weeklyStats.daysWithMeals, 1))}g
                </div>
                <div className="text-xs text-muted-foreground">per day</div>
              </div>
              <div className="bg-secondary/50 rounded-xl p-4">
                ...
                <div className="text-2xl font-bold">
                  {Math.round(weeklyStats.totalMeals / Math.max(weeklyStats.daysWithMeals, 1))}
                </div>
                <div className="text-xs text-muted-foreground">per day</div>
              </div>
            </div>
